...
{
    {
        ...
        if (mapWallet.count(block.vtx[0].GetHash()))
        {
            ...
            printf("    mine:  %d  %d  %s" PRI64d "", wtx.GetDepthInMainChain(), wtx.GetBlocksToMaturity(), wtx.GetCredit());
        }
    }
    printf("\n");
}
...
{
    {
        ...
        printf("CWallet::NewKeyPool wrote %s" PRI64d " new keys\n", nKeys);
    }
    return true;
}
...
{
    {
        ...
        while (setKeyPool.size() < (nTargetSize + 1))
        {
            ...
            printf("keypool added key %s" PRI64d ", size=%" PRIszu"\n", nEnd, setKeyPool.size());
        }
    }
    return true;
}
...
void CWallet::ReserveKeyFromKeyPool(int64& nIndex, CKeyPool& keypool)
{
    ...
    keypool.vchPubKey = CPubKey();
    {
        ...
        printf("keypool reserve %s" PRI64d "\n", nIndex);
    }
}
...
void CWallet::ReturnKey(int64 nIndex)
{
    ...
    printf("keypool return %s" PRI64d "\n", nIndex);
}
